...
// githubMetaLoader() calls report.count('repos', ...), which writes under
// COUNTS_DIR (src/data/generated/counts/ by default -- see report.ts).
...
beforeAll(() => {
  countsDir = mkdtempSync(join(tmpdir(), 'github-meta-counts-'));
